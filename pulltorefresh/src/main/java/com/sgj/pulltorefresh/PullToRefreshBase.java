...
import com.sgj.pulltorefresh.internal.FlipLoadingLayout;
import com.sgj.pulltorefresh.internal.LoadingLayout;
import com.sgj.pulltorefresh.internal.RotateLoadingLayout;
import com.sgj.pulltorefresh.internal.Utils;
import com.sgj.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private static boolean mIsLast;
	...
	public PullToRefreshBase(Context paramContext, Mode paramMode, boolean paramBoolean1, boolean paramBoolean2)
	{
		super(paramContext);
		this.mMode = paramMode;
		mIsFirst = paramBoolean1;
		mIsLast = paramBoolean2;
	...
	public static abstract interface OnRefreshListener2<V extends View> {
		 ...
		 */
		public abstract void onPullDownToRefresh(final PullToRefreshBase<V> refreshView);

		/**
		 * onPullUpToRefresh will be called only when the user has Pulled from
		 * the end, and released.
		 */
		public abstract void onPullUpToRefresh(final PullToRefreshBase<V> refreshView);
