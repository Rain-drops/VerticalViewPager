...
//			PullToRefreshWebView.this.onRefreshComplete();
	...
	public PullToRefreshWebView(Context paramContext, PullToRefreshBase.Mode paramMode, boolean paramBoolean1, boolean paramBoolean2)
	{
		super(paramContext, paramMode, paramBoolean1, paramBoolean2);
		setOnRefreshListener(defaultOnRefreshListener);
...
//		isReadyForPullEnd =  mRefreshableView.getScaleY() + mRefreshableView.getScale() >= exactContentHeight - mRefreshableView.getHeight();
